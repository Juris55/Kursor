...
export default function AIChat() {
  ...
  const handleAddProvider = async () => {
    ...
    console.log('handleAddProvider fields:', { type: newProxyType, host: newProxyHost, port: newProxyPort, user: newProxyUser })
    ...
    console.log('handleAddProvider: proxy=', proxy, 'name=', provider.name)
