...
export default function TerminalPanel() {
  ...
  useEffect(() => {
    ...
    container.style.cssText = 'flex:1;width:100%;height:100%;padding:4px;position:relative;display:flex;flex-direction:column'
  ...
  const handleNewTerminal = async (type: 'powershell' | 'cmd') => {
    ...
    newContainer.className = 'xterm-container'
    newContainer.style.cssText = 'flex:1;width:100%;height:100%;padding:4px;position:relative;display:flex;flex-direction:column'
